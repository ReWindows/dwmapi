//! Windissect-generated Rust FFI bindings for dwmapi.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "0E66C8DC2BADE510DB2339870EEDD5DF";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1534219485;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 11] = [100, 119, 109, 97, 112, 105, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1534219485 { return 0; }
